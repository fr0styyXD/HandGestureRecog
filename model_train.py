...
training_set = train_datagen.flow_from_directory(r'C:\Users\HP\Desktop\CPP\New\Image',
                                                 target_size=(sz, sz),
                                                 batch_size=10,
                                                 color_mode='grayscale',
                                                 class_mode='categorical')

test_set = test_datagen.flow_from_directory(r'C:\Users\HP\Desktop\CPP\New\Image',
                                            target_size=(sz , sz),
                                            batch_size=10,
                                            color_mode='grayscale',
                                            class_mode='categorical')
